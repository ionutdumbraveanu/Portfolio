...
<html>
    ...
    <body>
        ...
        <%
            ...
            ResultSet rs = jb.intoarceLinieDupaId("hotel", "idhotel", aux);
            rs.first();
            String Nume = rs.getString("nume");
            String Locatie = rs.getString("locatie");
            String Rating = rs.getString("rating");
            String DataConstructie = rs.getString("dataconstruire");
            rs.close();
            jb.disconnect();
        %>
        <form action="m2_hotel.jsp" method="post">
            <table align="center">
                ...
                <tr>
                    <td align="right">Data Constructie:</td>
                    <td> <input type="text" name="dataconstruire" size="30" value="<%= DataConstructie%>"/></td>
                </tr>
            ...
            <br>
            <p align="center">
        	<a href="modifica_camera.jsp"><button type="button" class="btn btn-primary">Back</button></a>
        </p>
        </form>
    </body>
</html>