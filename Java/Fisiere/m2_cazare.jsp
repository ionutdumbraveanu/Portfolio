...
<html>
    ...
    <body>
        ...
        <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idcazare"));
            String idhotel = request.getParameter("idhotel");
            String idcamera = request.getParameter("idcamera");
            String Status = request.getParameter("status");

            String[] valori = {idhotel, idcamera, Status};
            String[] campuri = {"idhotel", "idcamera", "status"};
            jb.modificaTabela("cazare", "idcazare", aux, campuri, valori);
            jb.disconnect();
        %>
        <h1 align="center">Modificarile au fost efectuate !</h1>
        <p align="center">
            <a href="tabela_cazare.jsp"><button type="button" class="btn btn-primary">Tabela Cazare</button></a>
            <br/>
    </body>
</html>