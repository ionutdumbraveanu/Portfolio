...
<html>
    ...
    <body>
        ...
        <div align="center">
        <div class="btn-group">
    <a href="nou_cazare.jsp"><button type="button" class="btn btn-primary">Adauga</button></a>
    <a href="modifica_cazare.jsp"><button type="button" class="btn btn-primary">Modifica</button></a>
    <a href="index.html"><button type="button" class="btn btn-primary">Home</button></a>
  	</div>	
  	</div>
  	<br>
        <form action="sterge_cazare.jsp" method="post">
